...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var x$2 = x4.a$2;
      var y = x4.b$2;
      return (this.eval__Lcalculator_Expr__sci_Map__D(x$2, references) + this.eval__Lcalculator_Expr__sci_Map__D(y, references))
    } else if ($is_Lcalculator_Minus(x1)) {
      var x5 = $as_Lcalculator_Minus(x1);
      var x$3 = x5.a$2;
      var y$2 = x5.b$2;
      return (this.eval__Lcalculator_Expr__sci_Map__D(x$3, references) - this.eval__Lcalculator_Expr__sci_Map__D(y$2, references))
    } else if ($is_Lcalculator_Times(x1)) {
      var x6 = $as_Lcalculator_Times(x1);
      var x$4 = x6.a$2;
      var y$3 = x6.b$2;
      return (this.eval__Lcalculator_Expr__sci_Map__D(x$4, references) * this.eval__Lcalculator_Expr__sci_Map__D(y$3, references))
    } else if ($is_Lcalculator_Divide(x1)) {
      var x7 = $as_Lcalculator_Divide(x1);
      var x$5 = x7.a$2;
      var y$4 = x7.b$2;
      return (this.eval__Lcalculator_Expr__sci_Map__D(x$5, references) / this.eval__Lcalculator_Expr__sci_Map__D(y$4, references))
    } else {
...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  ...
  var expr = new $c_Lcalculator_Polynomial$$anonfun$computeSolutions$1().init___Lcalculator_Signal__Lcalculator_Signal(a, b);
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__O__O = (function(v1) {
  return this.apply__Lcalculator_Signal__Lcalculator_Var($as_Lcalculator_Signal(v1))
});
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__Lcalculator_Signal__Lcalculator_Var = (function(v) {
...
$c_Lcalculator_Polynomial$$anonfun$computeSolutions$1.prototype.init___Lcalculator_Signal__Lcalculator_Signal = (function(a$2, b$2) {
  this.a$2$f = a$2;
  this.b$2$f = b$2;
  return this
});
$c_Lcalculator_Polynomial$$anonfun$computeSolutions$1.prototype.apply__sci_Set = (function() {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer) {
    return (function() {
      var x = $uD(arg$outer.b$2$f.apply__O());
      return $uD($g["Math"]["sqrt"](x))
    })
  })(this));
  var deltaRoot = new $c_Lcalculator_Signal().init___F0(expr);
  $m_Lcalculator_Signal$();
  var expr$1 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer$1) {
    return (function() {
      return (-$uD(arg$outer$1.b$2$f.apply__O()))
    })
  })(this));
  var bNeg = new $c_Lcalculator_Signal().init___F0(expr$1);
  $m_Lcalculator_Signal$();
  var expr$2 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer$2) {
    return (function() {
      return $uD(arg$outer$2.a$2$f.apply__O())
    })
  })(this));
  var a2 = new $c_Lcalculator_Signal().init___F0(expr$2);
  if (($uD(deltaRoot.apply__O()) < 0)) {
    return $as_sci_Set($m_s_Predef$().Set$2.apply__sc_Seq__sc_GenTraversable($m_sci_Nil$()))
  } else {
    var array = [(($uD(bNeg.apply__O()) + $uD(deltaRoot.apply__O())) / $uD(a2.apply__O())), (($uD(bNeg.apply__O()) + $uD(deltaRoot.apply__O())) / $uD(a2.apply__O()))];
