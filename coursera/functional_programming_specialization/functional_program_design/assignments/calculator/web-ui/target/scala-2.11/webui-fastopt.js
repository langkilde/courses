...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  ...
  var bNeg = new $c_Lcalculator_Signal().init___F0(expr);
  $m_Lcalculator_Signal$();
  ...
  var deltaRoot = new $c_Lcalculator_Signal().init___F0(expr$2);
  $m_Lcalculator_Signal$();
  var expr$3 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(delta$1$1, bNeg$1, a2$1, deltaRoot$1) {
    return (function() {
      if (($uD(delta$1$1.apply__O()) < 0)) {
        return $as_sci_Set($m_s_Predef$().Set$2.apply__sc_Seq__sc_GenTraversable($m_sci_Nil$()))
      } else {
        var array = [(($uD(bNeg$1.apply__O()) + $uD(deltaRoot$1.apply__O())) / $uD(a2$1.apply__O())), (($uD(bNeg$1.apply__O()) + $uD(deltaRoot$1.apply__O())) / $uD(a2$1.apply__O()))];
